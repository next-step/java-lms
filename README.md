...
# 🚀 4단계 - 수강신청(요구사항 변경)
- [x] pr 반영 #2
  - [x] object mother pattern 적용 검토 : session
  - [x] 기타 코멘트 검토 및 적용
...
- [x] 승인 기능 구현
  1. [x] 모든 강의는 누구나 수강 신청할 수 있다.
  2. [x] 강의 유형에 따라 수강 승인 방식이 다르다.
     2-1. [x] 일반 강의: 강사의 승인 없이도 수강이 가능하다.
     2-2. [x] 선발형 강의:
       - [x]  강사는 선발된 인원만 승인할 수 있다.
       - [x]  선발되지 않은 인원은 강사가 수강 신청을 취소할 수 있다.
