...
- [x] 이미지 비율이 3:2가 아니면 예외를 반환한다
- [x] 강의의 무료유료 타입을 이넘으로 정의한다
- [x] 강의의 상태를 이넘으로 정의한다
- [x] 수강신청을 한다
  - [x] 무료강의는 수강제한 없고 유료강의는 최대수강인원을 초과할 수 없다
  - [x] 유료 강의는 수강료와 일치하는 금액으로 결제했을 때 수강신청이 된다 
  - [x] 강의의 상태가 모집중일때만 수강신청이 된다
