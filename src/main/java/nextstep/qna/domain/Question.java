...
public class Question {
    ...
    DeleteHistory deleteQuestion(NsUser loginUser) throws CannotDeleteException {
    ...
    List<DeleteHistory> deleteAnswers(NsUser loginUser) throws CannotDeleteException {
