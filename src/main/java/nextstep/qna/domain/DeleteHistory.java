...
public class DeleteHistory {
    ...
    public static DeleteHistory answerOf(Answer answer, LocalDateTime createdDate) {
        return new DeleteHistory(ContentType.ANSWER, answer.getId(), answer.getWriter(), createdDate);
    }
