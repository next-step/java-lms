...
public class JdbcSessionRepository implements SessionRepository {
    ...
    public int save(Session session) {
        String sql = "insert into session (course_id, title, cover, cardinal_number, session_cost_type, state, max_user) values(?, ?, ?, ?, ?, ?, ?)";
    ...
    public Optional<Session> findById(long id) {
        String sql = "select id, course_id, title, cover, cardinal_number, session_cost_type, state, max_user from session where id = ?";
