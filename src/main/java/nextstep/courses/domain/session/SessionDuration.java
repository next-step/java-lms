...
public class SessionDuration {
    ...
    public SessionDuration(Long id, Long sessionId, LocalDateTime startAt, LocalDateTime endAt) throws InvalidSessionDurationException {
    ...
    private void validateDuration(LocalDateTime startAt, LocalDateTime endAt) throws InvalidSessionDurationException {
