...
public class Course {
    ...
    public Course(Long id, String title, Long creatorId, List sessions) {
    ...
    public Course(Long id, String title, Long creatorId, LocalDateTime createdAt, LocalDateTime updatedAt, List sessions) {
        this.id = id;
        this.title = title;
