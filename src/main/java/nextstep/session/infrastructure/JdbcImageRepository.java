...
public class JdbcImageRepository implements ImageRepository {
    ...
    public int save(Image image) {
        String sql = "insert into image (name, width, height, capacity, session_id, created_at, updated_at) values(?, ?, ?, ?, ?, ?, ?)";
    ...
    public Image findById(Long id) {
        String sql = "select id, name, width, height, capacity, session_id, created_at, updated_at from image where id = ?";
    ...
    public List<Image> findBySessionId(Long sessionId) {
        String sql = "select id, name, width, height, capacity, session_id, created_at, updated_at from image where session_id = ?";
        RowMapper<Image> rowMapper = (rs, rowNum) -> new Image(
                rs.getLong(1),
                rs.getString(2),
                rs.getInt(3),
