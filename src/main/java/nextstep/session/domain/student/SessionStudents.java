...
public class SessionStudents {
    ...
    public SessionStudents(List<SessionStudent> students, int maximumCapacity) {
        this.students = students.stream().collect(Collectors.toSet());
        this.maximumCapacity = maximumCapacity;
    }
    ...
    public boolean contains(SessionStudent student) {
        return students.contains(student);
    }

    public void enrollStudent(SessionStudent student) {
