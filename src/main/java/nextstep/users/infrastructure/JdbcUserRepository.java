...
public class JdbcUserRepository implements UserRepository {
    ...
    public Optional<NsUser> findByUserId(String userId) {
        String sql = "select id, user_id, password, name, email, `authorization`, created_at, updated_at from ns_user where user_id = ?";
        RowMapper<NsUser> rowMapper = (rs, rowNum) -> new NsUser(
                ...
                rs.getString(4),
                rs.getString(5),
            UserAuthorization.valueOf(rs.getString(6)),
