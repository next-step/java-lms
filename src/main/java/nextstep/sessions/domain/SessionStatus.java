...
public enum SessionStatus {
  ...
  public static SessionStatus from(Long order) {
    return Arrays.stream(SessionStatus.values()).filter(v -> v.order.equals(order))
        .findFirst()
