INSERT INTO ns_user (id, user_id, password, name, email, user_course_type, created_at)
values (1, 'javajigi', 'test', '자바지기', 'javajigi@slipp.net', 'FREE', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, password, name, email, user_course_type, created_at)
values (2, 'sanjigi', 'test', '산지기', 'sanjigi@slipp.net', 'PAYED', CURRENT_TIMESTAMP());
