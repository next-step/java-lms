INSERT INTO ns_user (id, user_id, password, name, email, created_at) values (1, 'javajigi', 'password', '자바지기', 'javajigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, password, name, email, created_at) values (2, 'sanjigi', 'password', '산지기', 'sanjigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, password, name, email, created_at) values (3, 'zipjigi', 'password', '집지기', 'zipjigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, password, name, email, created_at) values (4, 'bapjigi', 'password', '밥지기', 'bapjigi@slipp.net', CURRENT_TIMESTAMP());
...
INSERT INTO course (id, title, creator_id, created_at) VALUES (2, '자바 과정', 1, CURRENT_TIMESTAMP());
