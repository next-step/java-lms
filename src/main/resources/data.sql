...
VALUES (0, '객체지향 프로그래밍', 1, CURRENT_TIMESTAMP());

INSERT INTO session (id, title, creator_id, course_id, max_user_count, start_date, end_date, cover_image_url, price,
                     pay_type, status, created_at)
values (0, '객체지향 프로그래밍', 1, 0, 30, '2021-01-01', '2021-02-01', 'http://localhost:8080/images/testCover.png', 0, 'FREE',
