...
INSERT INTO session_cover_image (session_id, cover_image_name, cover_image_size, cover_image_width, cover_image_height, created_at)

SELECT
    id, cover_image_name, cover_image_size, cover_image_width, cover_image_height, created_at
FROM session
WHERE cover_image_name IS NOT NULL
  AND id NOT IN (SELECT session_id FROM session_cover_image);