...
INSERT INTO session (course_id, start_date, end_date, session_type, session_status, session_capacity, created_at) VALUES (0, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 5, 'FREE', 'RECRUITING', 1, CURRENT_TIMESTAMP());

INSERT INTO session (course_id, start_date, end_date, session_type, session_status, session_capacity, created_at) VALUES (1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP() + 5, 'FREE', 'PREPARING', 1, CURRENT_TIMESTAMP());
