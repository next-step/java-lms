...
INSERT INTO session (name, start_at, end_at, image_size, image_width, image_height, image_type, price, limit_count, status) values ('테스트강의', '2023-12-01', '2023-12-20', 1000, 300, 200, 'PNG', 1000, 3, 'RECRUITING');

INSERT INTO session_student (id, user_id, registration_at, session_id) values (1, 1, CURRENT_TIMESTAMP(), 1);
INSERT INTO session_student (id, user_id, registration_at, session_id) values (2, 2, CURRENT_TIMESTAMP(), 1);
