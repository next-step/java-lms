...
INSERT INTO session (started_at, ended_at, cover_image, payment_type, status, recruitment_status, student_capacity, created_at) VALUES (PARSEDATETIME('2023-04-03 00:00', 'yyyy-MM-dd hh:mm', 'en'), PARSEDATETIME('2023-06-01 00:00', 'yyyy-MM-dd hh:mm', 'en'), 'http://test.com/image1', '유료', '준비중', '모집중' ,5 ,CURRENT_TIMESTAMP());
