...
INSERT INTO ns_user (id, user_id, password, name, email, created_at) values (3, 'yumble', 'test', 'YUMBLE', 'yumble@naver.com', CURRENT_TIMESTAMP());
...
-- thumbnail 테이블 INSERT
INSERT INTO thumbnail (id, name, size, width, height, writer_id)
VALUES (1, 'thumbnail1.jpg', 1024 * 1024, 300, 200, 1),
       (2, 'thumbnail2.jpg', 1024 * 1024, 600, 400, 2);

-- session_type_free 테이블 INSERT
INSERT INTO session_type_free (session_type_id, writer_id) VALUES (1, 1);

-- session_type_paid 테이블 INSERT
INSERT INTO session_type_paid (session_type_id, max_students, session_fee, writer_id) VALUES (2, 3, 10000, CURRENT_TIMESTAMP, 1);

-- session 테이블 INSERT
INSERT INTO session (id, name, start_date, end_date, thumbnail_id, session_type_id, session_status, writer_id)
VALUES (1, 'Session FREE', '2023-11-01', '2023-12-31', 1, 1, 'RECRUITING', CURRENT_TIMESTAMP, 1),
       (2, 'Session PAID, FULL 3 PEOPLE', '2023-11-01', '2023-12-31', 2, 2, 'RECRUITING', CURRENT_TIMESTAMP, 1);

-- students 테이블 INSERT
INSERT INTO students (session_id, student_id, writer_id)
VALUES (1, 1, CURRENT_TIMESTAMP, 1),
       (1, 2, CURRENT_TIMESTAMP, 2),
       (2, 1, CURRENT_TIMESTAMP, 1),
