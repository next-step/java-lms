...
INSERT INTO course (id, title, generation ,creator_id, created_at) VALUES(1, '코스 제목1', 1, 1, CURRENT_TIMESTAMP());

INSERT INTO session (id, title, price, start_date, end_date, session_status, max_student_limit, course_id) VALUES (2, '세션 제목1', 1000, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'READY', 20, 1);
