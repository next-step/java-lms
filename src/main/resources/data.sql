INSERT INTO lms_user (user_id, password, name, role, created_at) values ('javajigi', 'test', '자바지기', 'ADMIN', CURRENT_TIMESTAMP());
INSERT INTO lms_user (user_id, password, name, role, created_at) values ('sanjigi', 'test', '산지기', 'ADMIN', CURRENT_TIMESTAMP());

insert into course (title, creator_id, created_at) values('java_course', 1, CURRENT_TIMESTAMP());
