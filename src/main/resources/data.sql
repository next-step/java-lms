...
INSERT INTO course (id, title, creator_id, created_at, updated_at) values (1, 'test', 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO course (id, title, creator_id, created_at, updated_at) values (2, 'test', 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
