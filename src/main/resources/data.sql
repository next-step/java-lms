INSERT INTO ns_user (id, user_id, password, name, email, `authorization`, created_at) values (1, 'javajigi', 'test', '자바지기', 'javajigi@slipp.net', 'STUDENT', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, password, name, email, `authorization`, created_at) values (2, 'sanjigi', 'test', '산지기', 'sanjigi@slipp.net', 'STUDENT', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, user_id, password, name, email, `authorization`, created_at) values (3, 'javamaster', 'admin', '자바신', 'iamjava@gmail.com', 'TEACHER', CURRENT_TIMESTAMP());
...
INSERT INTO session (id, course_id, image_id, start_date, end_date, pay_type, session_state, recruitment_state, max_student, fee, created_at) VALUES (5, 0, 10, '2025-04-11 00:00:00', '2025-05-11 00:00:00', 'PAID', 'PREPARING', 'NOT_RECRUITING', 1000, 10000, CURRENT_TIMESTAMP());
