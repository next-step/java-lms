INSERT INTO ns_user (user_id, password, name, email, created_at) values ('javajigi', 'test', '자바지기', 'javajigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO ns_user (user_id, password, name, email, created_at) values ('sanjigi', 'test', '산지기', 'sanjigi@slipp.net', CURRENT_TIMESTAMP());
