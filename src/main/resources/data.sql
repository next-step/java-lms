...
INSERT INTO session (name, start_at, end_at, image_size, image_width, image_height, image_type, price, limit_count, student_count, status) values ('테스트강의', '2023-12-01', '2023-12-20', 1000, 300, 200, 'PNG', 1000, 3, 1, 'RECRUITING');
