...
INSERT INTO ns_user (id, user_id, password, name, email, created_at)
values (2, 'sanjigi-sql', 'test', '산지기 SQL', 'sanjigi@slipp.net', CURRENT_TIMESTAMP());
...
VALUES
        (1, 1, '국내에서 Ruby on Rails와 Play가 활성화되기 힘든 이유는 뭘까?',
        ...
        (2, 2, 'runtime 에 reflect 발동 주체 객체가 뭔지 알 방법이 있을까요?',
