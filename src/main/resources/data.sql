-- NsUser 도메인
INSERT INTO ns_user (user_code, password, name, email, created_at)
...
-- Question 도메인
INSERT INTO question (question_id, WRITER_USER_CODE, title, contents, deleted, created_at, updated_at)
VALUES (101, 'javajigi-sql', '국내에서 Ruby on Rails와 Play가 활성화되기 힘든 이유는 뭘까?',
       ...
       (102, 'sanjigi-sql', 'runtime 에 reflect 발동 주체 객체가 뭔지 알 방법이 있을까요?',
...
-- Answer 도메인
INSERT INTO answer (answer_id, writer_user_code, contents, created_at, question_id, deleted)
VALUES (101, 'avajigi-sql',
