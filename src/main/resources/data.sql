INSERT INTO ns_user (id, session_id, user_id, password, name, email, created_at) values (1, null, 'javajigi', 'test', '자바지기', 'javajigi@slipp.net', CURRENT_TIMESTAMP());
INSERT INTO ns_user (id, session_id, user_id, password, name, email, created_at) values (2, null, 'sanjigi', 'test', '산지기', 'sanjigi@slipp.net', CURRENT_TIMESTAMP());
