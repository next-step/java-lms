...
INSERT INTO session(id, pay_type, session_status, recruiting_status, amount, students_capacity, start_date, end_date)
VALUES (1, 'PAY', 'PROGRESS', 'RECRUITING_ON', 10000, 100, CURRENT_DATE, CURRENT_DATE);
