INSERT INTO ns_user (user_id, password, name, email, created_at, updated_at)
VALUES ('javajigi', 'test', '자바지기', 'javajigi@slipp.net', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO ns_user (user_id, password, name, email, created_at, updated_at)
VALUES ('sanjigi', 'test', '산지기', 'sanjigi@slipp.net', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
...
INSERT INTO answer (writer_id, contents, created_at, updated_at, question_id, deleted)
VALUES (1,
...
INSERT INTO course (title, has_selection, creator_id, created_at, updated_at)
VALUES ('넥스트 스텝', false, 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());

INSERT INTO session (course_id, capacity, status, recruitment, price, start_date, end_date, creator_id, created_at,
                     updated_at)
VALUES (1, 10, 'ACTIVE', 'OPEN', 100000, '2025-04-21', '2025-05-21', 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
