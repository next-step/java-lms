...
INSERT INTO `session` (id, title, start_date, end_date, cover_image_url, is_free, registration_status, capacity, course_id) VALUES (1, 'TDD, 클린 코드 with Java 16기', CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP(), 'cover image url', true, 'OPEN', 10, 1);
