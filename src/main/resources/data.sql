...
INSERT INTO course (title, creator_id, cohort, created_at, updated_at) VALUES ('test title', 1, 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO session (name, start_date, end_date, course_id, created_at, updated_at) VALUES ('test session', DATE '2023-05-27', DATE '2023-06-20', 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
INSERT INTO session (name, start_date, end_date, course_id, created_at, updated_at) VALUES ('test session2', DATE '2023-05-27', DATE '2023-06-20', 1, CURRENT_TIMESTAMP(), CURRENT_TIMESTAMP());
