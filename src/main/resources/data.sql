...
INSERT INTO session (id, title, status, price, charge_type, start_at, end_at, max_number_of_attendees, cover_image) VALUES(1, 'TDD', 'END', 800000, 'CHARGED', '2023-04-03', '2023-06-01', 10, 'TDD_COVER_IMAGE');
INSERT INTO session_attendee (id, user_id, session_id) VALUES(1, 'javajigi', 1);
INSERT INTO session_attendee (id, user_id, session_id) VALUES(2, 'sanjigi', 1);