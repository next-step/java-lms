...
public class CommonTestFixture {
    ...
    public static final Answer A3 = new Answer(NsUserTest.JAVAJIGI, Q1, "Answers Contents3");
    public static final Answer A4 = new Answer(NsUserTest.JAVAJIGI, Q2, "Answers Contents3");
}
