...
public class AnswerTest {
  ...
  public void setUp() {
    ...
    a2 = new Answer(NsUserTest.SANJIGI, new Question(NsUserTest.JAVAJIGI, "title1", "contents1"), "Answers Contents2");
  }

  @Test
  @DisplayName("다른 사용자가 답변글을 입력한 경우 CannotDeleteException throw")
  public void validate_답변글_작성자() {
    assertThatThrownBy(() -> a1.validateIsOwner(NsUserTest.SANJIGI))
