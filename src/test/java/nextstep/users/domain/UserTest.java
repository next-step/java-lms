...
public class UserTest {
    ...
    public static final User INSTRUCTOR = new User(3L, "instructor", "password", "name", "instructor@slipp.net", UserType.INSTRUCTOR, LocalDateTime.of(2023, 5, 29, 12, 34, 56), null);
    ...
    public static final User DKSWNZZ = new User(5L, "dkswnzz", "password", "name", "dkswnzz@slipp.net", UserStatus.SELECTED_FOR_FREE, LocalDateTime.of(2023, 5, 29, 12, 34, 56), null);
}
