...
public class NsUserTest {
    ...
    public static final NsUser BADAJIGI = new NsUser(3L, "badajigi", "password", "name", "badajigi@slipp.net");
    public static final NsUser GANGJIGI = new NsUser(4L, "gangjigi", "password", "name", "gangjigi@slipp.net");
