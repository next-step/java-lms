...
public class NsUserTest {
    ...
    public static final NsUser HONUX = new NsUser(3L, "honux", "password", "name", "honux@slipp.net");
    public static final NsUser CRONG = new NsUser(4L, "crong", "password", "name", "crong@slipp.net");
}
