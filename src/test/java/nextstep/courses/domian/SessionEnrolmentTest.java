...
class SessionEnrolmentTest {
    ...
    void enrolment_유료() {
        ...
        SessionStudents sessionStudents = new SessionStudents(students, 3);
        ...
        boolean actual = sessionStudents.isMaxStudents();
    ...
    void enrolment_무료() {
        ...
        SessionEnrolment sessionEnrolment = new SessionEnrolment(sessionStudents, SessionStatusType.ONGOING, amount, true);
