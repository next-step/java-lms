...
public class SessionRepositoryTest {
	private final static Session session1 = new Session(
		...
		new SessionRegistration(PaidType.PAID, new Tuition(50000), new SessionCapacity(100), new Students()), new Course("코스", 1L));
	private final static Session session2 = new Session(
		...
		new Image(0.9d, "PNG", 300, 200), ProgressStatus.READY, ApplyStatus.APPLYING,
		new SessionRegistration(PaidType.PAID, new Tuition(100000), new SessionCapacity(100), new Students()), new Course("코스", 1L));
	@Autowired
