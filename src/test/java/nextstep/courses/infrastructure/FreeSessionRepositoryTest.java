...
public class FreeSessionRepositoryTest {
    ...
    private FreeSessionRepository sessionRepository;
    ...
    void testFreeSession() {
        ...
        Session findSession = sessionRepository.findBySessionId(freeSession.getId()).orElse(null);
    ...
    void testSessions() {
        ...
        assertThat(sessions.getSessions()).hasSize(1)
                .extracting(Session::getId).contains(freeSession.getId());
    }
