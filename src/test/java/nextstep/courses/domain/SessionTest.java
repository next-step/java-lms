...
public class SessionTest {
    ...
    @Test
    void test01() {
        Session freeSession = new FreeSession(LocalDateTime.now(), LocalDateTime.now().plusDays(1));
        freeSession.changeStatus(SessionStatus.RECRUITING);
        Session paidSession = new PaidSession(1, 10_000, LocalDateTime.now(), LocalDateTime.now().plusDays(1));
    ...
    void test02() {
        ...
        Session paidSession = new PaidSession(2, 10_000, LocalDateTime.now(), LocalDateTime.now().plusDays(1));
        paidSession.changeStatus(SessionStatus.RECRUITING);
