...
class SessionTest {
    ...
    void apply2() {
        ...
        Session session = new Session(0L, 0L, "테스트 타이틀", period, thumbnail, EnrollFactory.create(0L, 0L, EnrollType.PAID, 1,
    ...
    void apply3() {
        ...
        Session session = new Session(0L, 0L, "테스트 타이틀", period, thumbnail, EnrollFactory.create(0L, 0L, EnrollType.FREE, 0,
                amount), SessionStatus.RECRUITING, LocalDateTime.now(), null);
