...
public class SessionTest {
    ...
    @Test
    void test01() {
        Session session = new FreeSession(0L, CourseTest.C1.getId(), List.of(SessionCoverImageTest.CI), SessionType.FREE);
    ...
    class FreeSessionTest {
        ...
        @Test
        void test03() {
            FreeSession session = new FreeSession(0L, CourseTest.C1.getId(), List.of(SessionCoverImageTest.CI), SessionType.FREE);
            session.changeRecruitmentStatus(RecruitmentStatus.RECRUITING);
            assertThatCode(() -> {
    ...
    class PaidSessionTest {
        ...
        @Test
        void test04() {
            Session session = new PaidSession(0L, CourseTest.C1.getId(), 1, 10_000L, List.of(SessionCoverImageTest.CI), SessionType.PAID);
            session.changeRecruitmentStatus(RecruitmentStatus.RECRUITING);
            assertThatThrownBy(() -> {
        ...
        @Test
        void test05() {
            Session session = new PaidSession(0L, CourseTest.C1.getId(), 1, 9_000L, List.of(SessionCoverImageTest.CI), SessionType.PAID);
            session.changeRecruitmentStatus(RecruitmentStatus.RECRUITING);
