...
public class CourseTest {
    ...
    void course_AddSession_Test() {
        ...
        Session session1 = FreeSession.valueOf(1L, "과제3 - 사다리게임", course.getId()
                , EnrollmentStatus.CLOSE, LocalDate.now(), LocalDate.now(), LocalDateTime.now(), LocalDateTime.now());
        Session session2 = FreeSession.valueOf(1L, "과제4 - 레거시 리팩토링", course.getId()
