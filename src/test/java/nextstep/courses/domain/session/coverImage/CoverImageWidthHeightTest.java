...
class CoverImageWidthHeightTest {
    @Nested
    ...
    class InstanceCreationTest {
        ...
        class FailCaseTest {
            ...
            void testWrongWidthHeight(double width, double height) {
                assertThatThrownBy(() -> new CoverImageWidthHeight(width, height))
            ...
            void testWrongRatio() {
                assertThatThrownBy(() -> new CoverImageWidthHeight(302, 201))
                        .isExactlyInstanceOf(IllegalArgumentException.class);
            }
        }
        ...
        void testSuccessCase() {
            assertThatNoException().isThrownBy(() -> new CoverImageWidthHeight(300, 200));
        }
    }
}