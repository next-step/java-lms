...
public class CapacitySizeTest {
    ...
    void validateCapacityMax() {
        assertThatThrownBy(() -> new CapacitySize(1048577)).isInstanceOf(ImageFileInfoException.class)
    ...
    void validateCapacityMin() {
        assertThatThrownBy(() -> new CapacitySize(0)).isInstanceOf(ImageFileInfoException.class)
