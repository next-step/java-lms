...
class StudentsTest {
    ...
    void add() {
        ...
        // when & then
        assertThat(students.add(new Student(0L, JAVAJIGI.getId()))).isTrue();
    }
    ...
    void validateDuplicate() {
        // given
        Students students = new Students();
        students.add(new Student(0L, JAVAJIGI.getId()));

        // when & then
        assertThatThrownBy(() -> students.add(new Student(0L, JAVAJIGI.getId()))).isInstanceOf(IllegalArgumentException.class)
