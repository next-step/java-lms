...
public enum SessionFixture {
    ...
    SessionFixture(Long id, Long courseId, SessionInformation information, SessionStatus status, SessionAttendees attendees) {
        this.id = id;
    ...
    public Session session() {
        return new Session(id, courseId, information, status, attendees);
    }
}
