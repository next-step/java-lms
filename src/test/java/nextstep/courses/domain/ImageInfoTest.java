...
public class ImageInfoTest {
    ...
    void 이미지_용량_체크() {
        assertThatThrownBy(() -> new ImageInfo("GIF", 2L, 0,0))
    ...
    void 이미지_길이_체크() {
        assertThatThrownBy(() -> new ImageInfo("GIF", 1L, 270,180))
                .isInstanceOf(ImageException.class);
    }
    ...
    void 이미지_길이_비율_체크() {
        assertThatThrownBy(() -> new ImageInfo("GIF", 1L, 300,400))
                .isInstanceOf(ImageException.class);
    }
    ...
    void 이미지_형식_체크() {
        assertThatThrownBy(() -> new ImageInfo("TXT", 1L, 300,200))
                .isInstanceOf(ImageException.class);
    }
}
