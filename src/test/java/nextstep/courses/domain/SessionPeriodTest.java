...
class SessionPeriodTest {
    ...
    void 오늘_날짜가_강의_시작일_이전이_아니면_준비중_상태_예외_발생() {
        assertThatThrownBy(() -> todayAfterStartDate.checkSessionStatus(SessionState.PREPARING))
    ...
    void 오늘_날짜가_강의_시작일_이전이_아니면_모집중_상태_예외_발생() {
        assertThatThrownBy(() -> todayAfterStartDate.checkSessionStatus(SessionState.RECRUITING))
                .isInstanceOf(SessionPeriodException.class);
    }
    ...
    void 오늘_날짜가_강의_종료일_이후가_아니면_종료_상태_예외_발생() {
        assertThatThrownBy(() -> todayAfterStartDate.checkSessionStatus(SessionState.END))
                .isInstanceOf(SessionPeriodException.class);
    }
}