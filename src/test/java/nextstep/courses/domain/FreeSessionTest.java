...
public class FreeSessionTest {
    ...
    public static FreeSession F1 = new FreeSession(1L, SessionImageTest.S1, RecruitStatus.RECRUIT, SessionDateTest.of());
    ...
    void testEnrollment() {
        FreeSession freeSession = new FreeSession(sessionId, SessionImageTest.S1, RecruitStatus.RECRUIT, SessionDateTest.of());
