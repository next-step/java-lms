...
class UsersTest {
    ...
    void 유저들_정보수() {
        Users actual = Users.of(List.of(User.of(1L, Name.of("사용자"))));
    ...
    void 유저들_추가() {
        Users actual = Users.of(new ArrayList<>(List.of(User.of(1L, Name.of("사용자")))));
        User user = User.of(2L, Name.of("이름"));
        actual.add(user);
    ...
    void 유저들_생성() {
        Users actual = Users.of(List.of(User.of(1L, Name.of("사용자"))));
        assertThat(actual).isEqualTo(Users.of(List.of(User.of(1L, Name.of("사용자")))));
    }
