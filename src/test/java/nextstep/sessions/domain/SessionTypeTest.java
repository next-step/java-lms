...
public class SessionTypeTest {
    ...
    void FreeSessionIsAlwaysTrue() {
        assertThat(SessionType.FREE.isCapacityExceeded(10, 20)).isFalse();
        assertThat(SessionType.FREE.isCapacityExceeded(10, 10)).isFalse();
        assertThat(SessionType.FREE.isCapacityExceeded(10, 0)).isFalse();
    }
