...
public class SessionTest {
	...
	void notCourseEndDateEarlierThanStartDate() {
		...
		assertThatExceptionOfType(IllegalArgumentException.class)
				.isThrownBy(() -> {
					new Session(1L, "객체지향 프로그래밍", 1L, LocalDate.of(2024, 5, 2), LocalDate.of(2024, 5, 1), SessionType.PAID, 10000, 100);
	...
	void paidLectureCannotOverMaximumAttendees() {
		...
		assertThatExceptionOfType(IllegalArgumentException.class)
				.isThrownBy(() -> {
					new Session(1L, "객체지향 프로그래밍", 1L, LocalDate.of(2024, 5, 2), LocalDate.of(2024, 5, 6), SessionType.PAID, 100, 101);
	...
	void freeLectureCannotOverMaximumAttendees() {
		// given&when
		Session freeSession = new Session(1L, "객체지향 프로그래밍", 1L, LocalDate.of(2024, 5, 2), LocalDate.of(2024, 5, 6), SessionType.FREE, 100, 101);
