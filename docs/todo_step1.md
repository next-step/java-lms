# 1단계 - 레거시 코드 리팩터링
## 진행 방법
- [LMS - 수강신청에 대한 github 저장소](https://github.com/next-step/java-lms)를 기반으로 실습을 진행한다.
...
- 답변이 없는 경우 삭제가 가능하다.
- 질문자와 답변글의 모든 답변자가 같은 경우에만 삭제가 가능하다.
...
![as-is1](https://imgur.com/yByRxbr.png)

![as-is2](https://imgur.com/sPcOqO9.png)

TO-BE

![to-be](https://imgur.com/BTFVKZJ.png)
